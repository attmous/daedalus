...
def test_adapter_status_build_status_normalizes_raw_payload(monkeypatch, tmp_path):
    status_module = load_module("hermes_relay_workflows_code_review_status_test", "workflows/code_review/status.py")
...
def test_increment_no_progress_ticks_resets_on_approval_or_merge():
    status_module = load_module("hermes_relay_workflows_code_review_status_ipt", "workflows/code_review/status.py")
...
def test_write_lane_memo_writes_rendered_markdown(tmp_path):
    status_module = load_module("hermes_relay_workflows_code_review_status_wlm", "workflows/code_review/status.py")
    worktree = tmp_path / "worktree"
    worktree.mkdir()
...
def test_write_lane_state_emits_expected_payload_shape(tmp_path):
    status_module = load_module("hermes_relay_workflows_code_review_status_wls", "workflows/code_review/status.py")
    worktree = tmp_path / "worktree"
    worktree.mkdir()
...
def test_compute_ledger_drift_reports_lane_and_pr_mismatches():
    status_module = load_module("hermes_relay_workflows_code_review_status_drift", "workflows/code_review/status.py")
...
def test_resolve_publish_ready_workflow_state_maps_review_loop_states():
    status_module = load_module("hermes_relay_workflows_code_review_status_rpws", "workflows/code_review/status.py")
...
def test_derive_publish_status_returns_ready_draft_or_not_published():
    status_module = load_module("hermes_relay_workflows_code_review_status_dps", "workflows/code_review/status.py")
...
def test_resolve_prepublish_workflow_state_returns_implementing_local_when_no_candidate():
    status_module = load_module("hermes_relay_workflows_code_review_status_rpre", "workflows/code_review/status.py")
...
def test_apply_idle_ledger_transition_resets_active_lane_state():
    status_module = load_module("hermes_relay_workflows_code_review_status_idle", "workflows/code_review/status.py")
    ledger: dict = {
...
def test_apply_active_lane_error_ledger_transition_marks_blocked_state():
    status_module = load_module("hermes_relay_workflows_code_review_status_ale", "workflows/code_review/status.py")
    ledger: dict = {
        "approval": {"status": "approved", "approvedAt": "t", "approvedHeadSha": "h", "pendingReason": None},
        "workflowState": "implementing_local",
        "reviewState": "implementing_local",
...
def test_apply_active_lane_ledger_transition_sets_approved_for_clean_publish_ready_merge():
    status_module = load_module("hermes_relay_workflows_code_review_status_alt", "workflows/code_review/status.py")
...
def test_derive_latest_progress_returns_approved_event_when_published_pr_is_clean():
    status_module = load_module("hermes_relay_workflows_code_review_status_dlp", "workflows/code_review/status.py")
...
def test_assemble_status_payload_returns_fully_shaped_status_dict():
    status_module = load_module("hermes_relay_workflows_code_review_status_asp", "workflows/code_review/status.py")
...
def test_apply_ledger_reviews_and_header_writes_expected_keys():
    status_module = load_module("hermes_relay_workflows_code_review_status_alrh", "workflows/code_review/status.py")
    ledger: dict = {}
...
def test_apply_ledger_implementation_merge_preserves_prior_ledger_keys():
    status_module = load_module("hermes_relay_workflows_code_review_status_alim", "workflows/code_review/status.py")
