...
def test_compute_health_ignores_core_job_missing_when_engine_owner_is_hermes():
    health_module = load_module("hermes_relay_workflows_code_review_health_test", "workflows/code_review/health.py")
...
def test_collect_broken_watchers_filters_by_regex_and_error_text():
    health_module = load_module("hermes_relay_workflows_code_review_health_cbw", "workflows/code_review/health.py")
...
def test_disable_broken_watchers_disables_matching_jobs_and_returns_names():
    health_module = load_module("hermes_relay_workflows_code_review_health_dbw", "workflows/code_review/health.py")
    import re
...
def test_compute_core_job_status_splits_missing_disabled_and_stale():
    health_module = load_module("hermes_relay_workflows_code_review_health_cjs", "workflows/code_review/health.py")
